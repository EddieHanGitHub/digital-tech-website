...
if (imageQuality) {
    if (imageQuality == "high") {
        for (const itemOfArray in [...document.getElementsByClassName("Image")]) {
            document.getElementsByClassName("Image")[itemOfArray].src = document.getElementsByClassName("Image")[
